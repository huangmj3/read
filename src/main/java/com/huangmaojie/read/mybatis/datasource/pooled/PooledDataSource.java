 ...
 */
package com.huangmaojie.read.mybatis.datasource.pooled;

import com.huangmaojie.read.mybatis.datasource.unpooled.UnpooledDataSource;
...
public class PooledDataSource implements DataSource {
    ...
    public Connection getConnection() throws SQLException {
        //PooledConnection.getProxyConnection()方法获取数据库连接的代理对象。
     ...
     */
    /**
     * 当修改 PooledDataSource 的字段 时，例如数据库 URL、用户名、 密码、 autoCornmit配置等，
     * 都会调用 forceCloseAII()方法将所 有数据库连接关 闭，
     * 同 时也 会将 所 有 相 应 的 PooledConnection 对象都设置为无效，
     * 清 空 activeConnections 集合 和 idleConnections 集合
     */
